package com.dreamsoftware.fudge.component.menu
...
import com.example.compose_tv.FudgeExamples.components.menu.FudgeTvButton
import com.example.compose_tv.FudgeExamples.components.menu.FudgeTvButtonStyleTypeEnum
import com.example.compose_tv.FudgeExamples.components.menu.FudgeTvButtonTypeEnum
...
@Composable
fun FudgeTvFilterSideMenu(
    onClearFilters: () -> Unit,
    @StringRes titleRes: Int,
    @StringRes clearButtonTextRes: Int,
    filtrationFields: List<FudgeTvFilterVO>,
    onFieldClicked: (FudgeTvFilterVO) -> Unit
) {
